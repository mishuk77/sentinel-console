            ...
            <div className="bg-card border rounded-xl p-6 shadow-sm h-[450px]">
                ...
                {volume && volume.length > 0 ? (
                    ...
                    <div className="flex flex-col h-full items-center justify-center text-center p-8">
                        <div className="bg-muted/30 rounded-full h-14 w-14 flex items-center justify-center mb-4">
                            <TrendingUp className="h-7 w-7 text-muted-foreground/50" />
                        </div>
                        <h3 className="text-base font-semibold text-foreground mb-2">No Decision Data Yet</h3>
                        <p className="text-muted-foreground text-sm max-w-md mb-4">
                            Decision trends will appear here once you start processing applications through your active system.
                        </p>
                        {!status?.model?.name && (
                            <p className="text-xs text-muted-foreground bg-muted/30 px-4 py-2 rounded-lg">
                                <strong>Next step:</strong> Upload a dataset and train a model to activate your system.
                            </p>
                        )}
                    </div>
                )}
